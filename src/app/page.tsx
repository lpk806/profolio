      ...
      <header className="bg-white/80 backdrop-blur-lg shadow-sm sticky top-0 z-50">
        ...
        {isMenuOpen && (
          <div id="mobile-menu" className="md:hidden px-6 pb-4 space-y-2">
            ...
            <a
              href="#contact"
              className="block bg-blue-500 text-white text-center px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300"
            >
              Contact Me
            </a>
          </div>
      ...
      <main>
        ...
        >
          <div className="max-w-3xl mx-auto">
            <img
              src="https://placehold.co/128x128/e2e8f0/334155?text=VL"
        ...
        >
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-4xl mx-auto">
              <div className="skill-card bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
                <Box className="w-12 h-12 text-teal-500 mb-4" />
                <h3 className="text-lg font-semibold">Dart</h3>
              </div>
              <div className="skill-card bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
              ...
              <div className="skill-card bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
                <Apple className="w-12 h-12 text-gray-700 mb-4" />
        ...
        >
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="project-card bg-gray-50 rounded-lg shadow-lg overflow-hidden border">
                <img
                  src="https://placehold.co/600x400/e2e8f0/334155?text=Project+1"
                  alt="Project 1"
              ...
              <div className="project-card bg-gray-50 rounded-lg shadow-lg overflow-hidden border">
                <img
                  src="https://placehold.co/600x400/e2e8f0/334155?text=Project+2"
                  alt="Project 2"
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
        ...
        >
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row gap-8 max-w-4xl mx-auto">
              <div className="bg-white border border-gray-200 rounded-lg p-8 flex-1 flex flex-col items-center text-center">
        ...
        >
          <div className="container mx-auto px-6 text-center">
            ...
            <a
              ...
              className="bg-blue-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-600 transition duration-300 inline-block"
            >
              Send Email
            </a>
          </div>
